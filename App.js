...
// document.write("Index of 'n' is "+ pos);

/// Q  No 4 ///

//  var str = "Hello world";
// var pos = str.lastIndexOf("l");
// document.write(" Last Index of 'l' is "+ pos);
...
// Q NO 3////
//  Date.shortDay = [ 'Sun', 'Mon', 'Tue', 'wed', 'Thu', 'Fri','Sat'];

// function short_Day(dt)
//    { 
//      return Date.shortDay[dt.getDay()]; 
//    }

// dt = new Date(); 
// document.write(short_Day(dt)); 
...
// document.write("Today is " + Month[todayMonth]);
...
// var onlyLetters = str.toLowerCase().replace(/[^a-zA-Z0-9]+/g,'');
// var onlyLettersRev = onlyLetters.split('').reverse().join('');

// if (onlyLetters == onlyLettersRev) {
...
// document.write("<br>" +leapyear(2000));
// document.write("<br>" +leapyear(2012));
// document.write("<br>" +leapyear(1800));
// document.write("<br>" +leapyear(100));
